...
public enum ErrorCode {
    ...
    // Kafka Integration Errors (5xxx)
    INTEGRATION_KAFKA_MESSAGE_HANDLING(ErrorCategory.INTEGRATION, 5010, HttpStatus.INTERNAL_SERVER_ERROR,
                                       "Failed to process Kafka message"),
    INTEGRATION_KAFKA_MESSAGE_PUBLISH(ErrorCategory.INTEGRATION, 5011, HttpStatus.SERVICE_UNAVAILABLE,
                                      "Failed to publish message to Kafka"),
    INTEGRATION_KAFKA_MESSAGE_CONVERSION(ErrorCategory.INTEGRATION, 5012, HttpStatus.BAD_REQUEST,
                                         "Failed to convert Kafka message"),
    INTEGRATION_KAFKA_CONSUMER_ERROR(ErrorCategory.INTEGRATION, 5013, HttpStatus.SERVICE_UNAVAILABLE,
                                     "Kafka consumer operation failed"),
    INTEGRATION_KAFKA_PRODUCER_ERROR(ErrorCategory.INTEGRATION, 5014, HttpStatus.SERVICE_UNAVAILABLE,
                                     "Kafka producer operation failed"),
    INTEGRATION_KAFKA_CONNECTION_ERROR(ErrorCategory.INTEGRATION, 5015, HttpStatus.SERVICE_UNAVAILABLE,
                                       "Failed to establish connection with Kafka broker"),
